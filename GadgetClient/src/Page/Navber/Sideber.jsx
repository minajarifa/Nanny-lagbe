...
export default function Sideber() {
    ...
    return (
        <div>
            <aside className="flex flex-col w-64 px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                ...
                <div className="flex flex-col justify-between flex-1 mt-6">
                    <nav>
                        ...
                        <Link to="/NannyDashboard/AddPost" className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
